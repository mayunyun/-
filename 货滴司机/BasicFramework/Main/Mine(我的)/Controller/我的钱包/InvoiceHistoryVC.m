...
-(void)requestData{
    ...
    [NetWorkManagerTwo requestDataWithURL:[NSString stringWithFormat:@"%@%@",_Environment_Domain,urlstr] requestType:GET parameters:nil uploadProgress:^(float progress) {
