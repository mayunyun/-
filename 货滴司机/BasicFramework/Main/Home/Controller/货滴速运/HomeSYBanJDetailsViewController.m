//
//  HomeSYBanJDetailsViewController.m
//  BasicFramework
//
...
#import "HomeSYBanJDetailsViewController.h"
#import "TongChBanViewController.h"

@interface HomeSYBanJDetailsViewController ()<UIScrollViewDelegate,AMapSearchDelegate>
...
@implementation HomeSYBanJDetailsViewController
...
-(void)fahuodanButClicked:(UIButton *)but{
    [SMAlert hide:NO];
    TongChBanViewController *tongchban = [[TongChBanViewController alloc]init];
    tongchban.push = @"1";
